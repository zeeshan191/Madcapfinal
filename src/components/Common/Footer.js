  ...
  <p><img src="madcaplogot.png" alt="madcaplogo" width="110" height="90" /></p>
    ...
    <div className="col-md-3 col-sm-6">
      ...
      <div className="footer-pad">
        ...
        <p><NavLink to="/connect">madcapsloution@gmail.com</NavLink><br />madcapsloution.com</p>
        </ul>
      </div>
    </div>
    <div className="col-md-3 col-sm-6">
      ...
      <div className="footer-pad">
        ...
        <ul className="list-unstyled">
        <li><NavLink to="/service">Analytic Solutions</NavLink></li>
    ...
    <div className="col-md-3 col-sm-6">
      ...
      <div className="footer-pad">
        ...
        <li><NavLink to="/connect" target="_self">Contact Us</NavLink></li>
